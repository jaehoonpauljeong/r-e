                    ...
                    if int(vehicle.getParameter(vehicle_id, "actualBatteryCapacity")) == 200:
                        ...
                        for charging_station_dict in charging_station_list:
                            if vehicle.getRoadID(vehicle_id) != lane.getEdgeID(
                                ...
                                if min_expect_time <= simulation.findRoute(vehicle.getRoadID(vehicle_id), lane.getEdgeID(chargingstation.getLaneID(charging_station_dict["charging_station_id"]))).travelTime:
                                    min_expect_time=simulation.findRoute(vehicle.getRoadID(vehicle_id), lane.getEdgeID(chargingstation.getLaneID(charging_station_dict["charging_station_id"]))).travelTime
                        while True:
                            ...
                            if vehicle.getRoadID(vehicle_id) != lane.getEdgeID(
                                ...
                                print(simulation.findRoute(vehicle.getRoadID(vehicle_id), lane.getEdgeID(chargingstation.getLaneID(charging_station_dict["charging_station_id"]))).travelTime)
